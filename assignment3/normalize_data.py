'''
    Locally normalize the data, save as ./data/normalized_data.npy
    Split data into training and validation: train_data.npy and val_data.npy
'''
import numpy as np
...
np.save('./data/normalized_data.npy',norm_all_instances)
